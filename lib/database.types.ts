  ...
  public: {
    Tables: {
      ...
      creative_project_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "creative_project_members_invited_by_fkey"
            columns: ["invited_by"]
            isOneToOne: false
            referencedRelation: "passport_summary"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "creative_project_members_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "passport_summary"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "creative_project_members_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
      ...
      creative_projects: {
        ...
        Relationships: [
          {
            foreignKeyName: "creative_projects_owner_id_fkey"
            columns: ["owner_id"]
            isOneToOne: false
            referencedRelation: "passport_summary"
            referencedColumns: ["id"]
      ...
      passport_consent_grants: {
        ...
        Relationships: [
          {
            foreignKeyName: "passport_consent_grants_decided_by_fkey"
            columns: ["decided_by"]
            isOneToOne: false
            referencedRelation: "passport_summary"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "passport_consent_grants_requested_by_fkey"
            columns: ["requested_by"]
            isOneToOne: false
            referencedRelation: "passport_summary"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "passport_consent_grants_revoked_by_fkey"
            columns: ["revoked_by"]
            isOneToOne: false
            referencedRelation: "passport_summary"
            referencedColumns: ["id"]
      ...
      passport_relationships: {
        ...
        Relationships: [
          {
            foreignKeyName: "passport_relationships_proposed_by_fkey"
            columns: ["proposed_by"]
            isOneToOne: false
            referencedRelation: "passport_summary"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "passport_relationships_responded_by_fkey"
    ...
    Functions: {
      ...
      passport_consent_transition_allowed: {
        Args: { p_from: string; p_to: string }
        Returns: boolean
      }
      passport_controls: {
      ...
      passport_purpose_allows_category: {
        Args: { p_category: string; p_purpose: string }
        Returns: boolean
      }
      ...
      passport_relationship_transition_allowed: {
        Args: { p_from: string; p_to: string }
        Returns: boolean
      }
      passport_request_consent: {
        Args: {
          p_categories: string[]
          p_context_id?: string
      ...
      passport_respond_consent: {
        Args: {
          p_approve: boolean
          p_approved_categories?: string[]
          p_expires_at?: string
          p_id: string
        }
        Returns: Json
      }
      passport_respond_relationship: {
      ...
      passport_withdraw_consent_request: {
        Args: { p_id: string }
        Returns: Json
      }
