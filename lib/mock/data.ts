...
export const mockOrganizations: MockOrganization[] = [
  { id: "org-1", name: "The Dockside Tavern", logo_url: avatar("dockside"), city: "Buffalo", state: "NY", description: "Waterfront restaurant & event space on the Buffalo River.", verified: true, industry: "Hospitality", member_perk: "15% off for FLOW members", rating: 4.7, lat: 42.8749, lng: -78.8748, location_visibility: "exact" },
  { id: "org-2", name: "Queen City Studios", logo_url: avatar("queencity"), city: "Buffalo", state: "NY", description: "Photo & video production studio serving WNY brands.", verified: true, industry: "Creative", member_perk: null, rating: 4.9, lat: 42.9021, lng: -78.8935, location_visibility: "exact" },
  { id: "org-3", name: "Larkin Square Events", logo_url: avatar("larkin"), city: "Buffalo", state: "NY", description: "Community events and markets in the Larkin District.", verified: true, industry: "Events", member_perk: "Free entry to summer series", rating: 4.8, lat: 42.8721, lng: -78.8586, location_visibility: "exact" },
  { id: "org-4", name: "Elmwood Fitness Collective", logo_url: avatar("elmwood"), city: "Buffalo", state: "NY", description: "Independent gym and training studio on Elmwood Ave.", verified: true, industry: "Fitness", member_perk: "$10 FLOW member day pass", rating: 4.6, lat: 42.9058, lng: -78.8677, location_visibility: "approximate" },
  { id: "org-5", name: "BuffState Stagehands Union Local 5", logo_url: avatar("stagehands"), city: "Buffalo", state: "NY", description: "Live event production crew placement.", verified: true, industry: "Trades", member_perk: null, rating: 4.5, lat: 42.8874, lng: -78.8745, location_visibility: "exact" },
  { id: "org-6", name: "Root & Bloom Cleanup Crew", logo_url: avatar("rootbloom"), city: "Buffalo", state: "NY", description: "Neighborhood beautification nonprofit.", verified: false, industry: "Nonprofit", member_perk: null, rating: 4.9, lat: 42.8991, lng: -78.9106, location_visibility: "hidden" },
  { id: "org-7", name: "Canalside Markets", logo_url: avatar("canalside"), city: "Buffalo", state: "NY", description: "Seasonal vendor markets at Canalside.", verified: true, industry: "Retail", member_perk: "Vendor fee waived first market", rating: 4.4, lat: 42.8797, lng: -78.8756, location_visibility: "exact" },
  { id: "org-8", name: "Pearl Street Grill Group", logo_url: avatar("pearlstreet"), city: "Buffalo", state: "NY", description: "Downtown restaurant group, 3 locations.", verified: true, industry: "Hospitality", member_perk: "10% off for FLOW members", rating: 4.3, lat: 42.8858, lng: -78.8767, location_visibility: "exact" },
];
