...
import { Plus, Clock, ShieldCheck, XCircle, AlertTriangle, Ban } from "lucide-react";
    ...
    <div className="space-y-3">
      <ul className="space-y-2">
        {verifications.map((v) => {
          ...
          const Icon = cfg.icon;
          return (
            <li key={v.id} className="flex items-center justify-between rounded-xl border border-ink-200 p-3 text-sm dark:border-ink-800">
              <div>
