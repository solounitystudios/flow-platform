...
import { Briefcase, Building2, Compass, Plus, Users, Star, Ticket } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <Button href="/events" variant="outline" className="justify-start">
          <Ticket className="h-4 w-4" /> Sponsor an event
        </Button>
      </div>
